...
set_location_assignment PIN_J15 -to arst_n_i

set_location_assignment PIN_D3 -to en_i
set_location_assignment PIN_C3 -to ratio_clk_o

set_location_assignment PIN_D5 -to ratio_i[0]
set_location_assignment PIN_A6 -to ratio_i[1]
set_location_assignment PIN_D6 -to ratio_i[2]
set_location_assignment PIN_C6 -to ratio_i[3]

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to clk_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to arst_n_i

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to en_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ratio_clk_o

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ratio_i[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ratio_i[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ratio_i[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ratio_i[3]
